    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-32">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {['PPOR', 'Investor', 'Developer', 'First Home Buyer'].map(strategy => (
                            <Badge
                              ...
                              className={`cursor-pointer ${filters.strategyFocus.includes(strategy) ? 'bg-amber-600 hover:bg-amber-700' : 'hover:border-amber-500'}`}
        ...
        {compareAgents.length > 0 && (
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t-2 border-amber-500 shadow-2xl z-40">
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-3 mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-semibold text-amber-600">{agent.medianDaysToSecure || 'N/A'} days</span>
          </div>
          ...
          {agent.auctionSuccessRatio && (
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-amber-600">{agent.auctionSuccessRatio}%</span>
            </div>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1">
            {agent.services && agent.services.slice(0, 2).map((service, index) => (
              <Badge key={index} variant="outline" className="text-xs border-amber-300 dark:border-amber-600">
                {service}
              </Badge>
            ))}
          </div>
